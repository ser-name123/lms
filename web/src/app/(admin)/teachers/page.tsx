...
export default function TeachersPage() {
  ...
  return (
    <>
      <Topbar title="Manage Employees" subtitle="Overview and administration of teaching staff, credentials, and recruitment" />

      {/* Tabs navigation panel */}
      <div className="border-b border-hairline bg-surface px-4 sm:px-6">
        <div className="flex gap-6">
          {[
            { id: "teachers", label: "Teachers" },
            { id: "others", label: "Other Employees" },
            ...
            <button
              ...
              className={cn(
                "h-14 font-bold text-sm border-b-2 transition-all duration-200 focus:outline-none relative py-4 px-1 cursor-pointer",
                activeTab === t.id 
                        ...
                        <div className="absolute top-2 right-2">
                          ...
                          {activeMenuId === teacher.id && (
                            <>
                              ...
                              <div className="absolute right-0 mt-1 w-36 rounded-xl border border-hairline bg-surface shadow-pop p-1 z-20 animate-fade-in">
                                <button
